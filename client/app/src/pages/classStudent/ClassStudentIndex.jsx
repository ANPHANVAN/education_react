    ...
    <div className="block h-[calc(100vh-3.5rem)] sm:flex">
      ...
      >
        <ul onClick={handleClick} className="">
          <ListItem NavLink="information">Thông Tin Lớp</ListItem>
          ...
          <ListItem NavLink="teacher-info">Giáo Viên</ListItem>
        </ul>
      </div>
...
export default ClassStudentIndex;
