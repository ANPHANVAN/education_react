    ...
    <header className="bg-header sticky top-0 z-50 flex h-14 items-center justify-between px-3">
      ...
      <div className="items-center justify-start sm:flex">
        <nav
          ...
          id="navbarCollapse"
          className={`bg-header dark:bg-black-2 bg-gray-[--color-tertiary] absolute top-full right-0 w-auto max-w-[250px] rounded-bl-3xl px-4 py-0 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none lg:dark:bg-transparent ${
            !open && 'hidden'
          } `}
        >
